...
static int MS_TS_MSG_IC_GPIO_INT = 0;
 ...
 struct pinctrl *_gTsPinCtrl = NULL;
 struct pinctrl_state *_gPinCtrlStateActive = NULL;
 struct pinctrl_state *_gPinCtrlStateSuspend = NULL;
 struct pinctrl_state *_gPinCtrlStateRelease = NULL;

...
extern u8 IS_FIRMWARE_DATA_LOG_ENABLED;
 ...
 extern struct pinctrl_state *_gPinCtrlStateActive;
 extern struct pinctrl_state *_gPinCtrlStateSuspend;
 extern struct pinctrl_state *_gPinCtrlStateRelease;
	...
	
    {
	 ...
	 pinctrl_select_state(_gTsPinCtrl, _gPinCtrlStateActive);
        ...
        else if (pBlank == FB_BLANK_POWERDOWN)
        {
            ...
            pinctrl_select_state(_gTsPinCtrl, _gPinCtrlStateSuspend);
